...
func main() {
	...
	pdf.SetTextColor(0, 0, 0) // RGB untuk hitam
	yPos = pdf.GetY() + margin + 5
	for row := 0; row < 20; row++ { // termasuk header
		xPos := 13.0
		for col := 0; col < 9; col++ {
			pdf.SetXY(xPos, yPos)
			if col > 3 {
	...
	imgIconRed4X := 58.0
	imgIconRed4Y := 203.5
	imgIconRed4Width := 14.5
	pdf.Image("mini_red_shrimp.png", imgIconRed4X, imgIconRed4Y, imgIconRed4Width, 0, false, "", 0, "")
	...
	imgIconGreen4X := 100.0
	imgIconGreen4Y := 203.5
	imgIconGreen4Width := 12.5
	pdf.Image("mini_green_shrimp.png", imgIconGreen4X, imgIconGreen4Y, imgIconGreen4Width, 0, false, "", 0, "")
	...
	imgIconBlack4X := 145.0
	imgIconBlack4Y := 203.5
	imgIconBlack4Width := 13.5
	pdf.Image("black_shrimp.png", imgIconBlack4X, imgIconBlack4Y, imgIconBlack4Width, 0, false, "", 0, "")
